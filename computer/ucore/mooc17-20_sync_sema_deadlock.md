...
11. 条件变量是管程内的等待机制。进入管程的线程因资源被占用而进入等待状态，每个条件变量表示一种等待原因，对应一个等待队列。
```
Class Condition {
    int numWaiting = 0;
    WaitQueue q;
...
16. 基本同步方法
![basic_sync_method](pictures/sync_method.jpg)

## 第十九讲 实验七 同步互斥

1. 哲学家就餐问题的底层支撑技术
![methods_for_philosophers_eat_lunch_problem](philosophers_eat_lunch_problem.png)
