...
- [x] 学习《数据结构与算法分析》（1个月）（学完前4章）
- [x] 学习《计算机网络》（学完前2章）
- [x] 学习vim使用技巧（1个月）
- [x] 学习shell脚本编程, 包括grep, awk, sed（1个月）
- [x] 学习Python（1个月）（读完《Python学习手册》前8章）
- [x] 学习XML、HTML、CSS与JavaScript （2个月）（读完《JavaScript语言精髓与编程实践》前4章）
- [ ] 学习《算法导论》（1个月）
- [ ] 学习《现代操作系统》（1.5个月）
...
>  总结：
> 1. 2017年制定的计划太激进了，导致很多计划无法完成。2018年要吸取教训，制定适合自己的、经过努力能够实现的计划吧。
> 2. 黄昆：“读书不是越多越好、越深越好，而是应该与自己驾驭知识的能力相匹配。”
> 3. 徐宥：“慢即是快，笨笨地做一遍题是学习的捷径。”

### 编程

- [ ] 搭建个人博客 （1个月）（完成需求分析，但后来学习数据结构而暂时中止）
- [ ] 开发排队系统 （2个月）
- [ ] 开发教育网站 （2个月)

> 总结：
> 由于今年主要精力放在恶补计算机基础上，尚未开始应用实践。没关系，先打好基础，以后可以慢慢捣鼓各种事情。
...
> 总结：
> 1. 2017年原计划阅读心理学的书籍，最终却阅读了社会学、文学和中国哲学类书籍。没关系吧，根据自己的兴趣去阅读吧，关键是读完之后要学以致用。
> 2. 多写读书笔记
...
- [x] 记完词根单词2000个（复习词根单词1000个，记忆词根新单词900个）
- [x] 记完词缀单词2000个（复习词缀单词700个）
- [ ] 记完《美丽新世界》单词3000个
- [ ] 记完《全球通史》单词4000个
...
### 12月
- [x] 【工作】CMO事务：源码交付、ICP搭建、写总结文档等
- [x] 【技术】读完《数据结构》第4～5章并完成习题（第4章习题完成36/46）
- [x] 【单词】记完root3单词600个（累计1300个）（记完200个，累计900个）

### 12月25日 ～ 12月31日
- [x] 【工作】CMO事务优化、写总结文档（完成ICP搭建等）
- [ ] 【技术】完成《数据结构与算法分析》第4章第37～46题（第37题“B树”尚未完成）
- [x] 【技术】看完《计算机网络》第2章（完成，正在看第3章“数据链路层”）
- [x] 【阅读】读完《解忧杂货店》
- [x] 【单词】记完root3单词50个，累计900个
- [x] 【电影】看完《站台》
- [x] 【运动】每晚健身、周三踢球

### 12月18日 ～ 12月24日
- [x] 【工作】CMO事务优化、问题定位（Saturn源码交付等，尚未投入问题定位）
- [x] 【技术】完成《数据结构与算法分析》第4章第30～39题（完成第30～36题）
- [x] 【技术】看完《计算机网络》第2章（看完第2章前6节）
- [x] 【探索】本周稍微了解计算机图形学
- [x] 【单词】记完root3单词50个，累计850个
- [x] 【运动】每晚做俯卧撑、浅蹲、拉腿、运球
- [x] 【运动】周三踢球、周日骑车往返图书馆
- [x] 【电影】周三看完《2046》

### 12月11日 ～ 12月17日
- [x] 【工作】CMO事务：ICP自动提交工程等（搭建R19C00 ICP、解决10GE参数反向加载问题等）
- [x] 【技术】完成《数据结构与算法分析》第4章第27～36题（只完成第27～29题）
- [x] 【单词】记完root3单词100个，累计850个（记完50个，累计800个）
- [x] 【探索】通信网架构及接入网技术（浏览了《光纤接入网规划设计手册》等）
- [x] 【运动】每天晚上在家练习运球
- [x] 【电影】周六加班到凌晨1点，所以本周没看电影

> 备注：
> 1. 本周周一发烧，晚上8:30吃完药后睡到第二天早上8点。第二天基本康复了。估计与周日晚上在寒冷的天气下骑车回来后又穿着短袖回公司刷版本有关。以后还是要注意防寒保暖，尤其是运动后小心受凉。
> 2. 本周周四～周六加班搞问题，所以这几天没学习数据结构，进度又延缓了，须加倍努力。
...
- [ ] 【阅读】读《大人造命》前七章
- [x] 【单词】复习完prefix后200个单词
- [x] 【电影】看《窃听风暴》

#### 3月6日 ～ 3月12日

- [x] 【工作】ETHOAM端口联动特性开发（10%, 参加澄清）
- [x] 【工作】解决NAT创建默认流的问题（100%）
- [x] 【工作】IP Redirect特性联调（50%）
- [x] 【工作】serdes 10GE参数代码优化（50%）
- [ ] 【工作】学习知识管理及构建知识管理库（0%）
- [x] 【技术】学完《构建之法》（100%，粗略读完）
- [ ] 【技术】复习《程序员的自我修养》（0%）
- [x] 【阅读】读完《大人造命》讲义（50%，还在看前5章）
- [ ] 【写作】写《大人造命》读书笔记（0%）
- [x] 【单词】复习prefix单词约400个（50%，复习了240个）
- [x] 【电影】看《达拉斯买家俱乐部》

### 2月

- [x] 【工作】打补丁，解决ISSU后端口link灯不亮的问题（100%）
- [x] 【工作】同步代码，把R17C10 10GE参数的代码同步到R18C00（100%）
- [x] 【工作】特性开发，完成IP Redirect特性开发（100%）
- [ ] 【工作】完成《二层转发学习总结》（0%）
- [ ] 【工作】完成《三层转发学习总结》（0%）
- [x] 【工作】完成《CPU收发报文学习总结》（10%，阅读cputr源码并画了函数调用关系图）
- [ ] 【工作】完成《Dopra基础知识学习总结》（0%）
- [x] 【技术】学完《 深入理解计算机系统 》第11,12章（100%）
- [x] 【技术】学完《程序员的自我修养》（100%）
- [ ] 【阅读】读完《批判性思维工具》（0%）
- [x] 【阅读】读完《大人造命》讲义（50%，读完前5章）
- [x] 【写作】写《精进》读书笔记（100%）
- [x] 【写作】写《暗时间》读书笔记（100%）
- [ ] 【写作】写《沉默的大多数》读书笔记（0%）
- [ ] 【写作】写《批判性思维工具》读书笔记（0%）
- [x] 【单词】记完root3单词500个，复习prefix、suffix和root单词2000个（50%，记完root3单词）
