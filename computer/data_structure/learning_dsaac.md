...
### 17. 学习数据结构真有趣
大二时我几乎逃掉了所有的数据结构课，而现在我痛改前非自学数据结构时，却发现数据结构原来这么有趣。我的自学方法其实就是看书和做编程习题。看完相关章节后，除了部分证明题外，我基本能解决所有的课后习题，虽然有些题目要思考较长时间才能解决。大概是经过努力刷掉一道道题目带给我的成就感和自信心，让我觉得数据结构很有趣吧。想起陶哲轩的一句话：“发展数学兴趣所要做的最重要的事情是有能力和自由与数学玩。”管它呢，开心就好。just for fun.最近还在学习树结构，我迫不及待地想弄懂AVL树、splay树、B+树和红黑树等各种树的原理，那感觉比森林探险时遇到一棵棵葱葱郁郁的、直插云霄的参天古树还要激动和欣喜。
